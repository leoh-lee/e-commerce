...
public interface CouponApi {
    ...
    ApiResponse<List<UserCouponSearchResponse>> searchUserCoupons(@RequestParam Long userId);
    ...
    ApiResponse<List<AvailableCouponResponse>> searchAvailableCoupons(@RequestParam Long userId);
